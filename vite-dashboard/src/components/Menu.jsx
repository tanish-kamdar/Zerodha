...
const Menu = () => {
  ...
  async function handleLogout() {
    ...
    //Backend API integration remaining.
    user.dispatch({
      type: "LOGOUT",
      payload: {
        user: null,
      ...
      <div className="menus">
        <ul className="mb-0">
          <li>
            ...
            >
              <p className={menuSelected === 0 ? "menu selected" : "menu"}>
                Dashboard
              </p>
            </Link>
          </li>
          <li>
            <Link
              ...
              style={{ textDecorationLine: "none" }}
            >
              <p className={menuSelected === 1 ? "menu selected" : "menu"}>
                Orders
              </p>
            </Link>
          </li>
          <li>
            <Link
              ...
              style={{ textDecorationLine: "none" }}
            >
              <p className={menuSelected === 2 ? "menu selected" : "menu"}>
                Holdings
              </p>
            </Link>
          </li>
          <li>
            <Link
              ...
              style={{ textDecorationLine: "none" }}
            >
              <p className={menuSelected === 3 ? "menu selected" : "menu"}>
                Positions
              </p>
            </Link>
          </li>
          <li>
            <Link
              ...
              style={{ textDecorationLine: "none" }}
            >
              <p className={menuSelected === 4 ? "menu selected" : "menu"}>
                Funds
              </p>
            </Link>
          </li>
          <li>
            <Link
              ...
              style={{ textDecorationLine: "none" }}
            >
              <p className={menuSelected === 5 ? "menu selected" : "menu"}>
                Apps
              </p>
            </Link>
          </li>
