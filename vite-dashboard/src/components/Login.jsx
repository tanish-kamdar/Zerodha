...
import existingUserSchema from '../schemas/existingUser';
...
const KiteLogo = () => (
  // A simple SVG representation of the Kite logo
...
const GooglePlayIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    <path d="M21.53,10.74l-3.23-3.23a1,1,0,0,0-1.42,0l-1.41,1.41,4.24,4.24,1.82-1.82A1,1,0,0,0,21.53,10.74Z" /><path d="M2.34,3.76,8.23,9.65l-4.24,4.24L2.2,12.1a1,1,0,0,1,0-1.41Z" /><path d="M10,21.66,3.76,15.42,2,17.18a1,1,0,0,0,0,1.41l1.82,1.82L8.58,25.2a1,1,0,0,0,1.42,0Z" /><path d="M12.1,2.2,3.76,10.54l1.77,1.77,8.34-8.34L12.1,2.2a1,1,0,0,0-1.41,0Z" /><path d="M13.88,10l-4.24,4.24,5.9,5.89,4.24-4.24Z" />
  </svg>
);
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white p-8 rounded-md shadow-sm border border-gray-200">
          <div className="flex flex-col items-center gap-y-6">
            <KiteLogo />
            <h1 className="text-lg font-light text-gray-600">Login to Kite</h1>
            ...
            <a href="#" className="text-sm text-gray-500 hover:text-[#ff5722]">
        ...
        <div className="text-center mt-6 space-y-4">
            <div className="flex justify-center items-center space-x-5 text-gray-500">
                <a href="#" className="hover:text-gray-800 transition-colors"><GooglePlayIcon /></a>
                <a href="#" className="hover:text-gray-800 transition-colors"><AppleIcon /></a>
            </div>
            <div>
                 <p className="text-gray-400 tracking-[0.25em] text-sm font-light">ZERODHA</p>
            </div>
        </div>
        ...
        <div className="text-center mt-6 space-y-4">
          ...
          <div className="text-xs text-gray-400 leading-relaxed px-2">
            <p>
                Zerodha Broking Limited: Member of NSE, BSE - SEBI Reg. no. INZ000031633, CDSL - SEBI Reg. no. IN-DP-431-2019 | 
                <a href="#" className="text-gray-500 hover:text-[#ff5722] mx-1">Smart Online Dispute Resolution</a> |
                <a href="#" className="text-gray-500 hover:text-[#ff5722] mx-1">SEBI SCORES</a>
            </p>
